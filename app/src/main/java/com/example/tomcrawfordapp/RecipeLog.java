...
//            Toolbar mToolbarContact = RootView.findViewById(R.id.toolbar);
        ...
        private void searchRecipe(String search) {
            ...
            String URL = "https://api.spoonacular.com/recipes/search?query=" + search + "&number=30&instructionsRequired=true&apiKey=8febb4f26e774763bae7f1664386961d";
...
//                                    searchRecipe.add(new Recipe(jsonObject1.optString("name"), jsonObject1.optString("title"), "https://spoonacular.com/recipeImages/" + jsonObject1.optString("image"), Integer.parseInt(jsonObject1.optString("servings")), Integer.parseInt(jsonObject1.optString("readyInMinutes"))));
                                }
